...
import (
	...
	"cafeteria-delivery/internal/config"
	"cafeteria-delivery/internal/core/services"
	customErrors "cafeteria-delivery/internal/errors"
	"cafeteria-delivery/internal/http/handlers"
	"cafeteria-delivery/internal/http/middlewares"
	"cafeteria-delivery/internal/http/routes"
	"cafeteria-delivery/internal/repositories"
...
func main() {
	...
	routes.ItemCategoryRoutes(app, itemCategoryHandlers)
	routes.ItemRoutes(app, itemHandlers)
	routes.OrderRoutes(app, orderHandlers)
